...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 11, 2019 at 06:47 AM
...
INSERT INTO `tb_inwards` (`fd_inward_id`, `fd_date`, `fd_from`, `fd_item_id`, `fd_item_type_id`, `fd_item_manufacturer_id`, `fd_quantity`, `fd_rate`, `fd_mode_of_receiving`, `fd_remarks`) VALUES
(1, '2019-10-08', 'Accel Systems', 6, 0, 0, 2, '50', 'By Hand', 'Mr. X'),
(3, '2019-09-10', 'Accel Systems', 12, 0, 0, 2, '122222', 'By Speed Post', 'for  DCWIS'),
(4, '2019-09-10', 'Accel Systems', 12, 0, 0, 2, '122222', 'By Speed Post', 'for  DCWIS');
...
(44, 'Teamlink DL', ''),
(45, 'Converter', 'Serial to Ethernet,with adaptor'),
...
(1, '2019-10-02', 75, 46, 0, 0, 1, 'By Hand', 'asa'),
(2, '2019-10-02', 27, 12, 35, 0, 2, 'By Hand', 'Mr. X');
...
--
ALTER TABLE `tb_inwards`
  MODIFY `fd_inward_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `tb_items`
--
ALTER TABLE `tb_items`
  MODIFY `fd_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;
--
-- AUTO_INCREMENT for table `tb_item_manufacturers`
--
ALTER TABLE `tb_item_manufacturers`
  MODIFY `fd_item_manufacturer_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tb_item_types`
--
ALTER TABLE `tb_item_types`
  MODIFY `fd_item_type_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
--
-- AUTO_INCREMENT for table `tb_outwards`
--
ALTER TABLE `tb_outwards`
  MODIFY `fd_outward_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `tb_serial_numbers`
--
ALTER TABLE `tb_serial_numbers`
  MODIFY `fd_serial_number_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
