...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 30, 2019 at 06:57 AM
...
CREATE TABLE `tb_inwards` (
  ...
  `fd_number` varchar(128) NOT NULL,
  `fd_date` date NOT NULL,
  `fd_shipment_mode` varchar(128) NOT NULL,
...
CREATE TABLE `tb_items` (
  ...
  `fd_description` varchar(256) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `tb_items` (`fd_item_id`, `fd_name`, `fd_manufacturer`, `fd_description`) VALUES
(2, 'a', 'a', 'a'),
(3, 'a', 'a', 'a');
...
CREATE TABLE `tb_item_types` (
  ...
  `fd_opening_stock_date` date NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `tb_item_types` (`fd_item_type_id`, `fd_item_id`, `fd_type`, `fd_opening_stock`, `fd_opening_stock_date`) VALUES
(10, 2, 'b', 20, '2019-09-05'),
(9, 2, 'a', 10, '2019-09-01'),
(12, 3, 'a', 10, '2019-09-01');
...
--
-- Indexes for table `tb_item_details`
--
ALTER TABLE `tb_item_details`
  ADD PRIMARY KEY (`fd_item_detail_id`);
...
--
ALTER TABLE `tb_inwards`
  MODIFY `fd_inward_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tb_items`
--
ALTER TABLE `tb_items`
  MODIFY `fd_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `tb_item_details`
--
ALTER TABLE `tb_item_details`
  MODIFY `fd_item_detail_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tb_item_types`
--
ALTER TABLE `tb_item_types`
  MODIFY `fd_item_type_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
...
--
ALTER TABLE `tb_serial_numbers`
  MODIFY `fd_serial_id` int(11) NOT NULL AUTO_INCREMENT;
--
