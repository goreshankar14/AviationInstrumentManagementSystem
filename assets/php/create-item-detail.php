...
if (isset ($_POST['item_id']) && isset ($_POST['tx_quantity']) && isset ($_POST['tx_rate']) && isset ($_POST['transaction_id']) && isset ($_POST['tx_transaction_type'])) {
	...
	$tx_transaction_type = mysqli_real_escape_string ($conn, trim ($_POST['tx_transaction_type']));
	
	$result = mysqli_query ($conn, "INSERT INTO tbl_item_details VALUES (NULL, ".$item_id.", ".$lc_quantity.", ".$lc_rate.", ".transaction_id.", '".$tx_transaction_type."');");
	if ($result)
