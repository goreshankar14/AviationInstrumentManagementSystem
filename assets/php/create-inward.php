...
if (isset ($_SESSION['session_user_id']) && isset ($_SESSION['session_user_type']) && isset ($_POST['tx_date']) && isset ($_POST['station_id']) && isset ($_POST['item_id']) && isset ($_POST['tx_quantity']) && isset ($_POST['tx_serial_number']) && isset ($_POST['tx_rate']) && isset ($_POST['tx_mode_of_receiving']) && isset ($_POST['tx_remarks'])) {
	if ($_SESSION['session_user_type'] === "Administrator" || $_SESSION['session_user_type'] === "Inward") {
		...
		$result = mysqli_query ($conn, "INSERT INTO tb_inwards VALUES (NULL, '".$lc_date."', ".$lc_station_id.", ".$lc_item_id.", ".$lc_item_type_id.", ".$lc_item_manufacturer_id.", ".$lc_quantity.", ".$lc_rate.", '".$lc_mode_of_receiving."', '".$lc_remarks."');");	
